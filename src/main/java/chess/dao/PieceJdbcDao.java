...
public class PieceJdbcDao implements PieceDao {
    ...
    public void saveAllPieces(Map<Position, Piece> pieces) {
        try (Connection connection = DBConnector.getConnection();
             PreparedStatement statement = connection.prepareStatement(
                     "INSERT INTO chess.Piece (file, `rank`, type, color) VALUES (?, ?, ?, ?)")) {
    ...
    public Map<Position, Piece> findPieces() {
        try (Connection connection = DBConnector.getConnection();
             PreparedStatement statement = connection.prepareStatement(
                     "SELECT file, `rank`, type, color FROM chess.Piece")) {
    ...
    public void removeAllPieces() {
        try (Connection connection = DBConnector.getConnection();
             PreparedStatement statement = connection.prepareStatement("DELETE FROM chess.Piece")) {
